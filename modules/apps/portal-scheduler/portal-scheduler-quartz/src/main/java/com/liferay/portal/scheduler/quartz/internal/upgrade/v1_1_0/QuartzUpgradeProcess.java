...
public class QuartzUpgradeProcess extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		try (LoggingTimer loggingTimer = new LoggingTimer();
			...
			while (resultSet.next()) {
				...
				jobNamesMap.put(
					...
					SchedulerEngine.getPartitionedName(
						message.getLong("companyId"), jobName));
			}
			...
			_updateJobNames(
				"job_name", jobNamesMap,
				new String[] {
					"QUARTZ_FIRED_TRIGGERS", "QUARTZ_JOB_DETAILS",
					"QUARTZ_TRIGGERS"
				});

			_updateJobNames(
				"trigger_name", jobNamesMap,
				new String[] {
	...
	private void _updateJobNames(
			String columnName, Map<String, String> jobNamesMap,
			String[] tableNames)
		throws Exception {
